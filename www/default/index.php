...
<ul class="nav">
	...
	<li><a href="http://vvv.test:1080">Mailcatcher</a></li>
...
<ul class="nav">
	<li><a href="http://local.wordpress.test/">http://local.wordpress.test</a> for WordPress stable (www/wordpress-default)</li>
	<li><a href="http://src.wordpress-develop.test/">http://src.wordpress-develop.test</a> for trunk WordPress development files (www/wordpress-develop/src)</li>
	<li><a href="http://build.wordpress-develop.test/">http://build.wordpress-develop.test</a> for a Grunt build of those development files (www/wordpress-develop/build)</li>
</ul>
</body>
</html>
